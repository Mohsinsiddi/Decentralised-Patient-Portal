      ...
      <div>
        <div>
          ...
          <div className="container" style={{ padding: "10%" }}>
            ...
            <h3 className="text-center">ADD HOSPITAL ADMIN</h3>
            <br />
            <input className="form-control" placeholder="Enter Name..." onChange={(e) => { this.setState({ name: e.target.value }) }} />
            <br />
            <br />
            <input className="form-control" placeholder="Enter Hospital Address..." onChange={(e) => { this.setState({ hospital: e.target.value }) }} />
            <br />
